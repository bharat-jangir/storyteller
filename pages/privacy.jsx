...
function privacy() {
  return (
    <div>
      <Header />
      <div style={{ width: "100%", height: "auto", display: "flex", wordWrap: "wrap", flexWrap: "wrap", padding: "10px", justifyContent: "center", alignItems: "center" }}>
        <div>
          <h1>Privacy Policy for story teller</h1>
          <p>At story teller, accessible from <a style={{ color: 'blue' }} href="http://articlewriterblog.herokuapp.com/">http://articlewriterblog.herokuapp.com/</a>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by story teller and how we use it.</p>

          <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in story teller. This policy is not applicable to any information collected offline or via channels other than this website.</p>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>
              <p>Google</p>
              <p><a style={{ color: 'blue' }} href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a></p>
            </li>
          </ul>
        </div>
